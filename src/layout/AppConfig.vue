                ...
                <div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-wrap flex-col gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <RadioButton v-model="menuTheme" value="transparent" :checked="menuTheme === 'transparent'" name="menuTheme" @change="() => (layoutConfig.menuTheme = 'transparent')" inputId="transparent"></RadioButton>
