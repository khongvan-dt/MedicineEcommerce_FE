    ...
    <div class="grid grid-cols-12 gap-4 grid-nogutter">
      ...
      <div class="col-span-12 lg:col-span-6 h-full px-6 py-6 md:px-12">
        <ul class="flex list-none flex-wrap p-0 mb-12">
          <li class="flex items-center text-primary mr-2">Cart <i
              class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2"></i></li>
          <li class="flex items-center text-surface-500 dark:text-surface-300 mr-2">Information<i
              class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2"></i></li>
          <li class="flex items-center text-surface-500 dark:text-surface-300 mr-2">Shipping<i
              class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2"></i></li>
          <li class="flex items-center text-surface-500 dark:text-surface-300 mr-2">Payment</li>
        </ul>
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12 mb-12">
            <span class="text-surface-900 dark:text-surface-0 text-2xl block font-medium mb-8">Contact
              Information</span>
          ...
          <div class="col-span-12 mb-6">
            ...
            <Select :options="countries" v-model="selectedCountry" placeholder="Country / Region" optionLabel="name"
              showClear class="w-full"></Select>
          </div>
          ...
          <div class="col-span-12 flex flex-col lg:flex-row justify-center items-center lg:justify-end my-12">
            <Button class="mt-4 lg:mt-0 w-full lg:w-auto order-2 lg:order-1 lg:mr-6" severity="secondary" outlined
              label="Return to Cart" icon="pi pi-fw pi-arrow-left"></Button>
            <Button class="w-full lg:w-auto order-1 lg:order-2" label="Continue to Shipping"
          ...
          <div class="flex-auto lg:ml-4">
            ...
            <div class="flex flex-auto justify-between items-center">
              <InputNumber showButtons buttonLayout="horizontal" :min="0"
                inputClass="w-8 text-center py-2 px-1 border-transparent outline-0 shadow-none" v-model="quantities[0]"
